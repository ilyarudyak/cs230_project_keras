...
class BiggerLeakyUnet:
    ...
    def _build_model(self):
        ...
        acti1 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv1)
        ...
        acti2 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv2)
        ...
        acti3 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv3)
        ...
        acti4 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv4)
        ...
        acti5 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv5)
        ...
        acti6 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv6)
        ...
        acti7 = tf.keras.layers.LeakyReLU(alpha=0.001)(conv7)
        ...
        right_acti6 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv6)
        ...
        right_acti5 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv5)
        ...
        right_acti4 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv4)
        ...
        right_acti3 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv3)
        ...
        right_acti2 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv2)
        ...
        right_acti1 = tf.keras.layers.LeakyReLU(alpha=0.001)(right_conv1)
